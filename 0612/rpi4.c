...
/* STMicroelectronics 스펙 문서의 값 */
static const int CTRL_REG1 = 0x20;
static const int CTRL_REG2 = 0x21;

/* STMicroelectronics의 LPS25H 스펙 문서의 값 */
...
/* STMicroelectronics의 HTS221 스펙 문서의 값 */
...
int main(int argc, char **argv)
{
    ...
    /* I2C 장치를 슬레이브(slave) 모드로 HTS221을 설정 */
...
int kbhit(void)
{
    ...
    if(ch != EOF) {                     /* 앞에서 읽은 위치로 이전으로 포인터를 돌려준다. */
        ungetc(ch, stdin);
        return 1;
    }
